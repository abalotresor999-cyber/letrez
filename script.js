...
const translations = {
  fr: {
    ...
    'skill-1-text': "HTML, CSS, JavaScript, applications web complètes — de l'idée à la mise en ligne.",
  ...
  en: {
    ...
    'skill-1-text': 'HTML, CSS, JavaScript, full web applications — from idea to deployment.',
